...
| License | [Prosperity Public License 3.0.0](LICENSE.md) (free for non-commercial use; 30-day trial for commercial use) | Commercial license (1 license per person, no redistribution) |
...
[Prosperity Public License 3.0.0](LICENSE.md) — Free for non-commercial use (individuals, schools, nonprofits, etc.) indefinitely. Commercial use gets a 30-day free trial, after which a paid Patron License is required. Modification, redistribution, and resale are prohibited.
